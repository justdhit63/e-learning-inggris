            ...
            <section className="bg-white">
                <div className="max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-12">
                    <div className="flex items-center">
                        ...
                        <h2 className='text-2xl text-orange-500'><span className='font-bold'>Learn</span>Sphere</h2>
                    </div>
                </div>
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-6">
                        ...
                        <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white border border-gray-300 rounded-4xl hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 bg-orange-500">
                            Get Started
                        </a>
                    </div>
